...
export const messageCatalog = {
  ...
  'options.customPetTitle': '自定义宠物',
  'options.customPetHint': '仅支持 Codex v1/v2 精灵图：PNG 或 WebP，1536×1872 或 1536×2288，最大 6 MB。素材只保存在这台浏览器中。',
  'options.customPetNone': '还没有导入自定义宠物。',
  'options.customPetLoaded': '已导入 {name}（Codex v{version}）。',
  'options.customPetImport': '导入 Codex 宠物精灵图',
  'options.customPetRestore': '恢复默认小兔子并删除本地素材',
  'options.customPetInvalid': '无法读取这个文件。请使用小于 6 MB 的 PNG 或 WebP 精灵图。',
  'options.customPetFormat': '这不是 Codex v1/v2 精灵图。请使用 1536×1872 或 1536×2288 的文件。',
  'options.customPetRequiredCellEmpty': '精灵图第 {row} 行第 {column} 格应有动作帧，但目前是空的。',
  'options.customPetUnusedCellVisible': '精灵图第 {row} 行第 {column} 格应保持透明，但检测到了图像。',
  'options.customPetPreviewActions': '预览自定义宠物动作',
  'options.customPetAnimation.idle': '静止',
  'options.customPetAnimation.runningLeft': '向左跑',
  'options.customPetAnimation.runningRight': '向右跑',
  'options.customPetAnimation.waving': '挥手',
  'options.customPetAnimation.jumping': '跳跃',
  'options.customPetAnimation.failed': '失败',
  'options.customPetAnimation.waiting': '等待',
  'options.customPetAnimation.running': '处理中',
  'options.customPetAnimation.review': '检查',
  ...
  'organizer.groupDomain': '聚合未保护的 {count} 个',
  'organizer.groupProtected': '受保护',
  'organizer.groupPermissionDenied': '没有获得标签组权限，因此没有移动任何标签。你可以随时再试一次。',
  'organizer.groupResult': '已将 {grouped} 个标签页按网站聚合成浏览器标签组。',
  'organizer.groupPartial': '已聚合 {grouped} 个标签页，但有 {failed} 个窗口未完成。',
  'organizer.groupEmpty': '没有可聚合的标签；每个窗口至少需要两个未受保护标签。',
